...
class DACTL:
    ...
    def setup(self, model, data):
        ...
        self.L_arm_control = ARMCONTROL(model,data,self.L_params)
        self.R_arm_control = ARMCONTROL(model,data,self.R_params)
    ...
    def rebind(self, model, data):
        self.data = data
        self.model = model
        self.L_arm_control.rebind(model, data)
        self.R_arm_control.rebind(model, data)
